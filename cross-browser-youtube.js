...
videojs.Youtube = videojs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    cb_addEventListener(this.iframeblocker, 'click', togglePlayback);
    } else {
        ...
        cb_addEventListener(this.iframeblocker,'click', toggleActivity);
    }

    cb_addEventListener(this.iframeblocker, 'mousemove', function(e) {
    ...
    cb_addEventListener(this.iframeblocker, 'tap', function(){
      if (self.player_.userActive() === true) {
        self.player_.userActive(false);
      } else {
        self.player_.userActive(true);
...
videojs.Youtube.prototype.updateQualities = function(){
  ...
  if (qualities.length == 0) {
    ...
    for (var i = 0; i < qualities.length; ++i) {
      ...
      cb_addEventListener(el, 'click', function() {
